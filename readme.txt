=== itemprop WP for SEO Rich snippets ===
...
Tags: SEO, schema, schema.org, itemprop, schema.org itemprop, images, rich snippets, richsnippets
...
There are no questions for now! [Ask!](http://simplemediacode.info/snippets/add-itemprop-image-to-all-wordpress-images/)

== Screenshots ==

1. Content http://simplemediacode.info/snippets/add-itemprop-image-to-all-wordpress-images/
